#ifndef VVM_PHYSICS_RRTMGP_PROCESS_INTERFACE_HPP
#define VVM_PHYSICS_RRTMGP_PROCESS_INTERFACE_HPP
...
public:
    ...
    // Constructors
    VVM_RRTMGP_Interface(const VVM::Utils::ConfigurationManager& config, 
...
public:
    ...
    void run(VVM::Core::State& state, const double dt, const double current_time);
    void finalize();
...
#endif // VVM_PHYSICS_RRTMGP_PROCESS_INTERFACE_HPP
